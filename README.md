...
2. 送信先メールアドレスを `info@zelix-jp.com` に設定します。
...
- `assets/zelix-logo.jpg` - ヘッダー、favicon、フッター、OGP用ロゴ
- `assets/zelix-logo-glow.png` - 旧TOPファーストビュー用ロゴ保管
- `assets/zelix-logo-glow-original.png` - 旧元画像保管用
